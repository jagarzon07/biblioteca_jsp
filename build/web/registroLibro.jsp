<%-- 
    Document   : Registro Libro
    Created on : 9-ago-2021, 19:54:11
    Author     : Christian Gámez/Jose Garzon
--%>
                                                                                    ...
                                                                                    <form action="LibroControl" method="post" class="form-horizontal">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                         ...
                                                                                         <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="nombre_autor" value="" placeholder="Nombre completo"/>
                                                                                            </div>
                                                                                        </div>
                                                                                         ...
                                                                                         <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="publicacion" value="" placeholder="2020-01-31"/>
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <select name="categoria">
                                                                                                    ...
                                                                                                    <% for(Categoria c: CategoriaDao.listCategories()) { %>
                                                                                         ...
                                                                                         <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <select name="editorial">
                                                                                                    ...
                                                                                                    <% for(Editorial e: EditorialDao.listEditorial()) {%>
                                                                                        ...
                                                                                        <button name="accion" class="btn btn-success" value="registrar" type="submit">
                                                                                            <i class="fa fa-save"></i>
                                                                                            Registrar
                                                                                        </button>
                                                                                        
                                                                                        <button name="accion" class="btn btn-warning" value="actualizar" type="submit">
                                                                                            <i class="fa fa-edit"></i>
                                                                                            Actualizar
                                                                                        </button>
                                                                                        
                                                                                          <button name="accion" class="btn btn-danger" value="eliminar" type="submit">
