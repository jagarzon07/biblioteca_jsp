...
public class EditorialControl extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        edit.setEmail(email);
        edit.setSitioweb(sitioweb);
        
        if(EditorialDao.register(edit)) {
            request.setAttribute("mensaje", "La editorial fue creada.");
        }
        else {
            request.setAttribute("mensaje", "La editorial NO fue creada.");
        }
